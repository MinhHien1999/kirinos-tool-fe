...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="group bg-white border border-gray-100 rounded-xl p-3 shadow-sm hover:shadow-md transition-all duration-300 h-full flex flex-col w-full">
      ...
      {/* Vùng chứa ảnh - Giữ tỉ lệ 1:1 chuẩn */}
      ...
      <div className="flex flex-col flex-1">
        {/* Tên sản phẩm: Chữ thường, đậm vừa phải, kích thước chuẩn mobile/desktop */}
        ...
        {/* Hàng thông tin dưới cùng: Trạng thái bên trái, Liên hệ bên phải */}
